...
struct FeedView: View {
    ...
    init(
        ...
        _selectedPost = State(initialValue: MockData.feedPost(for: initialPostID, in: feedPosts.wrappedValue))
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    HStack(spacing: 12) {
                        ...
                        Spacer()
                        Button {
                            optionMessage = "피드 저장, 공유, 신고 옵션을 확인할 수 있어요."
                        } label: {
            ...
            HStack(spacing: 8) {
                ...
                Button {
                    ...
                    Image(systemName: "paperplane.fill")
                        ...
                        .foregroundStyle(.white)
                        .frame(width: 44, height: 44)
                        .background(comment.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty ? MoyeoTheme.text400 : MoyeoTheme.river)
                        .clipShape(Circle())
                }
                .buttonStyle(.plain)
